[![build](https://github.com/opspec-pkgs/openapispec.v3.validate-spec/actions/workflows/build.yml/badge.svg)](https://github.com/opspec-pkgs/openapispec.v3.validate-spec/actions/workflows/build.yml)
